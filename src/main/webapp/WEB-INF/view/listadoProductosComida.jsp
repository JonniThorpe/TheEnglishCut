...
<%
    List<Producto> productos = (List<Producto>) request.getAttribute("productosComida");
...
<body>
    ...
    <div class="p-5">
        <h1>Nuestra mejor coleccion productoss de comida</h1>
        <label>
