...
<%
    List<Producto> productos = (List<Producto>) request.getAttribute("productosMuebles");
...
<body>
    ...
    <div class="p-5">
        <h1>Nuestra mejor coleccion productoss de muebles</h1>
        <label>
            ...
            <div class="col col-12 col-sm-8 col-md-6 col-lg mb-3">
                <div class="card " style="width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <!--TODO da error en la linea de encima porque devuelve un inventario nulo, si eliminas la linea ejecuta bien -->
                        <%if(tipo.equals("Administrador")){%>
                            <div>
